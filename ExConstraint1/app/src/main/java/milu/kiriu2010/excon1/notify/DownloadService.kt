...
class DownloadService : Service() {
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        if ( Build.VERSION.SDK_INT >= Build.VERSION_CODES.O ) {
            ...
            if (manager.getNotificationChannel(NotificationChannelID.ID_DOWNLOAD.id) == null) {
                val mChannel = NotificationChannel(NotificationChannelID.ID_DOWNLOAD.id, name, NotificationManager.IMPORTANCE_HIGH)
                mChannel.apply {
        ...
        val builder = NotificationCompat.Builder(this, NotificationChannelID.ID_DOWNLOAD.id)
                .apply {
