package milu.kiriu2010.exdb1.glsl01.g005v
...
// ----------------------------------------------
class GLSLV05Renderer(ctx: Context): MgRenderer(ctx) {
    // 描画モデル
    ...
    // シェーダ
    private lateinit var shader: GLSLV05Shader
