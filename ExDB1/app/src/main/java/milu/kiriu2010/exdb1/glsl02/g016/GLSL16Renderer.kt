package milu.kiriu2010.exdb1.glsl02.g016
...
// -------------------------------------------
// オブジェクトの結合をスムースにする:VBOなし
// OpenGL ES 2.0
// -------------------------------------------
// https://wgld.org/d/glsl/g016.html
// -------------------------------------------
class GLSL16Renderer(ctx: Context): MgRenderer(ctx) {
    // 描画モデル
    private lateinit var model: Square01Model

    // シェーダ
    private lateinit var shader: GLSL16Shader
