package milu.kiriu2010.exdb1.glsl02.g018v
...
// -------------------------------------------
class GLSLV18Renderer(ctx: Context): MgRenderer(ctx) {
    // 描画モデル
    ...
    // シェーダ
    private lateinit var shader: GLSLV18Shader
