package milu.kiriu2010.exdb1.opengl05.w059v
...
// -----------------------------------------------------------------------
class WV059ShaderMain: ES20MgShader() {
    // 頂点シェーダ
    private val scv =
            """
    ...
    override fun loadShader(): ES20MgShader {
        ...
        // uniform(テクスチャユニット)
        hUNI[5] = GLES20.glGetUniformLocation(programHandle, "u_Texture")
    ...
    fun draw(model: MgModelAbs,
        ...
        // uniform(テクスチャユニット)
        GLES20.glUniform1i(hUNI[5], u_Texture)
