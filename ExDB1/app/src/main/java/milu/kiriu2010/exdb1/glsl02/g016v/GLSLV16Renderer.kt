package milu.kiriu2010.exdb1.glsl02.g016v
...
// -------------------------------------------
// オブジェクトの結合をスムースにする:VBOあり
// OpenGL ES 2.0
// -------------------------------------------
// https://wgld.org/d/glsl/g016.html
// -------------------------------------------
class GLSLV16Renderer(ctx: Context): MgRenderer(ctx) {
    // 描画モデル
    ...
    // シェーダ
    private lateinit var shader: GLSLV16Shader
