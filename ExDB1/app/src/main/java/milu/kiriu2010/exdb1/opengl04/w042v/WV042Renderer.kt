...
// ---------------------------------------------------------------------
class WV042Renderer(ctx: Context): MgRenderer(ctx) {

    // 描画オブジェクト(球体)
    private lateinit var modelSphere: Sphere01Model

    // シェーダ
    private lateinit var shader: WV042Shader
    ...
    override fun onDrawFrame(gl: GL10?) {
        ...
        shader.draw(modelSphere,boSphere,matM,matMVP,matI,vecLight,vecEye,0)
    }
