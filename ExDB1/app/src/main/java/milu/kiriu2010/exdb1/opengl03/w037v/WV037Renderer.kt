...
// ------------------------------------
class WV037Renderer(ctx: Context): MgRenderer(ctx) {
    ...
    // シェーダ
    private lateinit var shader: WV037Shader
    ...
    override fun onDrawFrame(gl: GL10?) {
        ...
        shader.draw(modelSphere,boSphere,matMVP,u_pointSize,0,1,GLES20.GL_POINTS)
        ...
        shader.draw(modelLine,boLine,matMVP,u_pointSize,-1,0,lineType)
    }
