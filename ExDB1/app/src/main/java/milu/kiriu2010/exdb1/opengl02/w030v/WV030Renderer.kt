...
// ---------------------------------------------------
class WV030Renderer(ctx: Context): MgRenderer(ctx) {

    // モデル
    private lateinit var model: Board01Model

    // シェーダ
    private lateinit var shader: WV030Shader
    ...
    override fun onDrawFrame(gl: GL10) {
        ...
        // テクスチャ描画
        shader.draw(model,bo,matMVP,vertexAplha[0],0,1)
        ...
        // ポリゴンを描画
        shader.draw(model,bo,matMVP,vertexAplha[1],0,0)
    }
