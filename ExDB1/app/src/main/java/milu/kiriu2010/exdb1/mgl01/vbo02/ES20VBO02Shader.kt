...
class ES20VBO02Shader: ES20MgShader() {
    ...
    override fun loadShader(): ES20MgShader {
        ...
        hATTR[0] = GLES20.glGetAttribLocation(programHandle, "a_Position").also {
            ...
            MyGLES20Func.checkGlError("glEnableVertexAttribArray")
            // attribute属性を登録
            GLES20.glVertexAttribPointer(it,3,GLES20.GL_FLOAT,false,0,0)
            MyGLES20Func.checkGlError("glVertexAttribPointer")
        }
        MyGLES20Func.checkGlError("glGetAttribLocation")
        ...
        MyGLES20Func.checkGlError("glGetUniformLocation")
