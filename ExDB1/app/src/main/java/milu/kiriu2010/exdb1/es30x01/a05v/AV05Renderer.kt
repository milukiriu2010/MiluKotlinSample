...
// -----------------------------------------
class AV05Renderer(ctx: Context): MgRenderer(ctx) {
    // 描画オブジェクト(板ポリゴン)
    ...
    // シェーダA
    private lateinit var shaderA: ES30Va05ShaderA
    // シェーダB
    private lateinit var shaderB: ES30Va05ShaderB
    ...
    override fun onSurfaceCreated(gl: GL10?, config: EGLConfig?) {
        ...
        // シェーダA
        shaderA = ES30Va05ShaderA()
        shaderA.loadShader()

        // シェーダB
        shaderB = ES30Va05ShaderB()
        shaderB.loadShader()
