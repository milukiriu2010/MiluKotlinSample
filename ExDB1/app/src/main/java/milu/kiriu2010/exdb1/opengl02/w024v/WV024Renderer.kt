package milu.kiriu2010.exdb1.opengl02.w024v
...
import milu.kiriu2010.gui.shader.es20.wvbo.ES20VBOPhongShading01Shader
...
// ---------------------------------------------------
class WV024Renderer(ctx: Context): MgRenderer(ctx) {

    // 描画モデル(トーラス)
    private lateinit var model: Torus01Model

    // シェーダ(フォンシェーディング)
    private lateinit var shader: ES20VBOPhongShading01Shader
    ...
    override fun onSurfaceCreated(gl: GL10, config: EGLConfig?) {
        ...
        // シェーダ(フォンシェーディング)
        shader = ES20VBOPhongShading01Shader()
        shader.loadShader()
