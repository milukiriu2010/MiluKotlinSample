...
// ------------------------------------
class WV068ShaderZoomBlur: ES20MgShader() {
    // 頂点シェーダ
    private val scv =
            """
    ...
    override fun loadShader(): ES20MgShader {
        ...
        // uniform()
        hUNI[2] = GLES20.glGetUniformLocation(programHandle, "u_strength")
        MyGLES20Func.checkGlError("u_strength:glGetUniformLocation")
        ...
        // uniform(マウス位置)
        hUNI[4] = GLES20.glGetUniformLocation(programHandle, "u_center")
        MyGLES20Func.checkGlError("u_center:glGetUniformLocation")
    ...
    fun draw(model: MgModelAbs,
        ...
        // uniform()
        GLES20.glUniform1f(hUNI[2], u_strength)
        ...
        // uniform(マウス位置)
        GLES20.glUniform2fv(hUNI[4],1, u_center,0)
