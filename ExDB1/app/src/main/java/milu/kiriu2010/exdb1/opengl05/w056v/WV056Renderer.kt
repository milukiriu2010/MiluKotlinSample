...
// -------------------------------------------
class WV056Renderer(ctx: Context): MgRenderer(ctx) {
    // 描画オブジェクト(トーラス)
    ...
    // シェーダ(laplacianフィルタ)
    private lateinit var laplacianShader: WV056ShaderLaplacian
    ...
    override fun onDrawFrame(gl: GL10?) {
        ...
        // 板ポリゴンの描画
        laplacianShader.draw(modelBoard,boBoard,matVP,0,u_laplacian,u_laplacianGray,u_Coef,renderW.toFloat())
    }
    ...
    override fun onSurfaceCreated(gl: GL10?, config: EGLConfig?) {
        ...
        // セピア調変換用シェーダ
        laplacianShader =  WV056ShaderLaplacian()
