...
import milu.kiriu2010.exdb1.opengl07.w076v.WV076Shader
...
// --------------------------------------
class WV076Renderer(ctx: Context): MgRenderer(ctx) {
    // 描画オブジェクト(トーラス)
    ...
    // シェーダ
    private lateinit var shader: WV076Shader
    ...
    override fun onDrawFrame(gl: GL10?) {
        ...
        (0..8).forEach { i ->
            ...
            shader.draw(modelTorus,boTorus,matMVP,matI,vecLight,u_dotScale)
        }
