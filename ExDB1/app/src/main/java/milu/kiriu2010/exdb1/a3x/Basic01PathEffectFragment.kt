package milu.kiriu2010.exdb1.a3x
...
class Basic01PathEffectFragment : Fragment()
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val view = inflater.inflate(R.layout.fragment_basic01_path_effect, container, false)
    ...
    companion object {
        @JvmStatic
        fun newInstance() =
                Basic01PathEffectFragment().apply {
