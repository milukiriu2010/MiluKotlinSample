package milu.kiriu2010.exdb1.opengl03.w034v
...
// --------------------------------------
class WV034Renderer(ctx: Context): MgRenderer(ctx) {
    ...
    private fun draw(qtn: MyQuaternion, ambientColor: FloatArray) {
        ...
        // モデルを描画
        shader.draw(model,bo,matMVP,matM,matI,vecLight,vecEye,ambientColor)
    }
