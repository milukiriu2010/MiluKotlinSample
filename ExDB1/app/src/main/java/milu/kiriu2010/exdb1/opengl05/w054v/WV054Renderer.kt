...
// -------------------------------------------
class WV054Renderer(ctx: Context): MgRenderer(ctx) {
    ...
    // シェーダ(セピア調変換)
    private lateinit var shaderSepia: WV054ShaderSepia
    ...
    override fun onDrawFrame(gl: GL10?) {
        ...
        shaderSepia.draw(modelBoard,boBoard,matVP, 0,u_grayScale,u_sepiaScale)
    }
