package milu.kiriu2010.exdb1.opengl01.w022v
...
import milu.kiriu2010.gui.shader.es20.wvbo.ES20VBOAmbientLight01Shader
...
// ---------------------------------------------------
class WV022Renderer(ctx: Context): MgRenderer(ctx) {

    // 描画モデル(トーラス)
    private lateinit var model: Torus01Model

    // シェーダ(拡散光)
    private lateinit var shader: ES20VBOAmbientLight01Shader
    ...
    override fun onDrawFrame(gl: GL10) {
        ...
        // モデル描画
        shader.draw(model,bo,matMVP,matI,vecLight,vecAmbientColor)
    }
    ...
    override fun onSurfaceCreated(gl: GL10, config: EGLConfig?) {
        ...
        // シェーダ(拡散光)
        shader = ES20VBOAmbientLight01Shader()
        shader.loadShader()
