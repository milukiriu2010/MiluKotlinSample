package milu.kiriu2010.exdb1.opengl04.w040v
...
// ---------------------------------------
class WV040Renderer(ctx: Context): MgRenderer(ctx) {
    ...
    // シェーダ
    private lateinit var shader: WV040Shader
    ...
    override fun onDrawFrame(gl: GL10?) {
        ...
        shader.draw(modelSphere,boSphere,matM,matMVP,matI,vecLight,0,1)
        ...
        Matrix.multiplyMM(matMVP,0,matVP,0,matM,0)
        Matrix.invertM(matI,0,matM,0)
        shader.draw(modelSphere,boSphere,matM,matMVP,matI,vecLight,1,0)
        ...
        Matrix.multiplyMM(matMVP,0,matVP,0,matM,0)
        Matrix.invertM(matI,0,matM,0)
        shader.draw(modelCube,boCube,matM,matMVP,matI,vecLight,1,0)
    }
