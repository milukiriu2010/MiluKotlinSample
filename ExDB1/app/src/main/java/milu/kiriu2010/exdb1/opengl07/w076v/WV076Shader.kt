package milu.kiriu2010.exdb1.opengl07.w076v
...
// --------------------------------------
// シェーダ(ハーフトーンシェーディング):VBOあり
// OpenGL ES 2.0
// --------------------------------------
// https://wgld.org/d/webgl/w076.html
// --------------------------------------
class WV076Shader: ES20MgShader() {
    // 頂点シェーダ
    private val scv =
            """
    ...
    override fun loadShader(): ES20MgShader {
        ...
        // uniform()
        hUNI[3] = GLES20.glGetUniformLocation(programHandle, "u_dotScale")
        MyGLES20Func.checkGlError("u_dotScale:glGetUniformLocation")
    ...
    fun draw(model: MgModelAbs,
        ...
        // uniform()
        GLES20.glUniform1f(hUNI[3], u_dotScale)
