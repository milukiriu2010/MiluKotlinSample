...
// --------------------------------------------------------------
class WV060Renderer(ctx: Context): MgRenderer(ctx) {
    // 描画オブジェクト(トーラス)
    ...
    // シェーダ(メイン)
    private lateinit var mainShader: WV060ShaderMain
    ...
    override fun onDrawFrame(gl: GL10?) {
        ...
        (0..8).forEach { i ->
            ...
            mainShader.draw(modelTorus,boTorus,matM,matMVP,matI,vecLight,vecEye,amb.toFloatArray(),
