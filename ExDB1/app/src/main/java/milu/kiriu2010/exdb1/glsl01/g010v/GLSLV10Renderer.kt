package milu.kiriu2010.exdb1.glsl01.g010v
...
// -------------------------------------------
class GLSLV10Renderer(ctx: Context): MgRenderer(ctx) {
    // 描画モデル
    ...
    // シェーダ
    private lateinit var shader: GLSLV10Shader
