...
class W081Fragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val view = inflater.inflate(R.layout.fragment_open_gl_w81, container, false)

        myGLES20View = view.findViewById(R.id.myGLES20ViewW81)
        val renderer = W081Renderer(context!!)
