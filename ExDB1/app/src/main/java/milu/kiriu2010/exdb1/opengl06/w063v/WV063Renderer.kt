...
// 半球ライティング
class WV063Renderer(ctx: Context): MgRenderer(ctx) {
    // 描画オブジェクト(トーラス)
    ...
    // シェーダ(メイン)
    private lateinit var mainShader: WV063ShaderMain
    ...
    override fun onDrawFrame(gl: GL10?) {
        ...
        Matrix.multiplyMM(matMVP,0,matVP,0,matM,0)
        Matrix.invertM(matI,0,matM,0)
        mainShader.draw(modelSphere,boSphere,matM,matMVP,matI,
                vecSky,vecLight,vecEye, colorSky, colorGround )
    }
