...
// --------------------------------------
class W089Renderer(ctx: Context): MgRenderer(ctx) {
    // 描画オブジェクト(トーラス)
    ...
    // シェーダ
    private lateinit var shader: W089Shader
    ...
    override fun onDrawFrame(gl: GL10?) {
        ...
        // 球体を描画
        shader.draw(modelSphere,matMVP,matN)

        // トーラスを描画
        shader.draw(modelTorus,matMVP,matN)
    }
