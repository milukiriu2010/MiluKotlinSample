...
// -----------------------------------------
class A05Renderer(ctx: Context): MgRenderer(ctx) {
    // 描画オブジェクト(板ポリゴン)
    ...
    // シェーダA
    private lateinit var shaderA: ES30a05ShaderA
    // シェーダB
    private lateinit var shaderB: ES30a05ShaderB
    ...
    override fun onSurfaceCreated(gl: GL10?, config: EGLConfig?) {
        ...
        // シェーダA
        shaderA = ES30a05ShaderA()
        shaderA.loadShader()

        // シェーダB
        shaderB = ES30a05ShaderB()
        shaderB.loadShader()
