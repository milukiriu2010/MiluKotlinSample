package milu.kiriu2010.exdb1.glsl02.g013v
...
// -------------------------------------------
class GLSLV13Renderer(ctx: Context): MgRenderer(ctx) {
    // 描画モデル
    ...
    // シェーダ
    private lateinit var shader: GLSLV13Shader
