package milu.kiriu2010.exdb1.opengl03.w036v
...
// --------------------------------------
class WV036Renderer(ctx: Context): MgRenderer(ctx) {
    ...
    // シェーダ
    private lateinit var shader: WV036Shader

    // VBO(球体)
    private lateinit var boSphere: ES20VBOAbs
    // VBO(線)
    private lateinit var boLine: ES20VBOAbs
    ...
    override fun onDrawFrame(gl: GL10?) {
        ...
        shader.draw(modelSphere,boSphere,matMVP,u_pointSize,GLES20.GL_POINTS)
        ...
        shader.draw(modelLine,boLine,matMVP,u_pointSize,lineType)
    }
