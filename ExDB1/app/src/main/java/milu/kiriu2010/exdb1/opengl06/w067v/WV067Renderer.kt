...
// WV067ShaderZoomBlur:a_TextureCoord:Board01Model:1281
// -----------------------------------
// ズームブラーフィルタ
// -----------------------------------
// https://wgld.org/d/webgl/w067.html
// -----------------------------------
class WV067Renderer(ctx: Context): MgRenderer(ctx) {
    // 描画オブジェクト(トーラス)
    ...
    // シェーダ(メイン)
    private lateinit var screenShader: WV067ShaderScreen
    // シェーダ(ズームブラー)
    private lateinit var zoomBlurShader: WV067ShaderZoomBlur
    ...
    override fun onDrawFrame(gl: GL10?) {
        ...
        // 板ポリゴンの描画
        zoomBlurShader.draw(modelBoard,boBoard,matVP,0,u_strength,renderW.toFloat())
    }
    ...
    override fun onSurfaceCreated(gl: GL10?, config: EGLConfig?) {
        ...
        // シェーダ(メイン)
        screenShader = WV067ShaderScreen()
        screenShader.loadShader()

        // シェーダ(ズームブラー)
        zoomBlurShader = WV067ShaderZoomBlur()
