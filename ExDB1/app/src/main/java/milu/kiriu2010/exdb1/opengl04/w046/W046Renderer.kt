...
class W046Renderer(ctx: Context): MgRenderer(ctx) {
    ...
    override fun onDrawFrame(gl: GL10?) {
        ...
        shader.draw(drawObjCube,matM,matMVP,vecEye,0,0,refractRatio)
        ...
        Matrix.multiplyMM(matMVP,0,matVP,0,matM,0)
        shader.draw(drawObjSphere,matM,matMVP,vecEye,-1,1,refractRatio)
        ...
        Matrix.multiplyMM(matMVP,0,matVP,0,matM,0)
        shader.draw(drawObjTorus,matM,matMVP,vecEye,-1,1,refractRatio)
    }
