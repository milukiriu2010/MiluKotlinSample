...
// --------------------------------------
class W087Renderer(ctx: Context): MgRenderer(ctx) {
    // 描画オブジェクト(球体)
    ...
    // シェーダ
    private lateinit var shader: W087Shader
    ...
    override fun onDrawFrame(gl: GL10?) {
        ...
        shader.draw(modelSphere,matM,matMVP,vecLight)
        ...
        (0..8).forEach { i ->
            ...
            Matrix.multiplyMM(matMVP,0,matVP,0,matM,0)
            shader.draw(modelTorus,matM,matMVP,vecLight)
        }
