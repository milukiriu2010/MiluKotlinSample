package milu.kiriu2010.exdb1.glsl02.g014v
...
// -------------------------------------------
class GLSLV14Renderer(ctx: Context): MgRenderer(ctx) {
    // 描画モデル
    ...
    // シェーダ
    private lateinit var shader: GLSLV14Shader
