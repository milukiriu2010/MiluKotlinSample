...
class W051Renderer: GLSurfaceView.Renderer {
    // 描画オブジェクト(トーラス)
    private lateinit var drawObjTorus: W051ModelTorus
    // 描画オブジェクト(板ポリゴン)
    private lateinit var drawObjBoard: W051ModelBoard
    ...
    override fun onDrawFrame(gl: GL10?) {
        ...
        (0..9).forEach { i ->
            ...
            drawObjTorus.draw(programHandleDepth,matM,matM4Tex,matMVP,matI,vecLight1,0)
        }
        ...
        Matrix.multiplyMM(matMVP,0,matT,0,matM,0)
        Matrix.invertM(matI,0,matM,0)
        drawObjBoard.draw(programHandleDepth,matM,matM4Tex,matMVP,matI,vecLight1,0)
    ...
    override fun onSurfaceCreated(gl: GL10?, config: EGLConfig?) {
        ...
        // モデル生成(トーラス)
        drawObjTorus = W051ModelTorus()

        // モデル生成(板ポリゴン)
        drawObjBoard = W051ModelBoard()
