...
// --------------------------------------------------------------------------------------------
class WV028Renderer(ctx: Context): MgRenderer(ctx) {

    // 描画オブジェクト
    private lateinit var model: WV028Model

    // シェーダ
    private lateinit var shader: WV028Shader
    ...
    private fun render(t: Float, trans: FloatArray) {
        ...
        // uniform変数の登録と描画
        shader.draw(model,bo,matMVP,0,1)
    }
