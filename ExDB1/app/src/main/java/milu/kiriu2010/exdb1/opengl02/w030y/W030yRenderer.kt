...
import milu.kiriu2010.exdb1.opengl02.w030.W030Shader
...
// ---------------------------------------------------
class W030yRenderer: GLSurfaceView.Renderer {
    // 描画オブジェクト
    private lateinit var drawObj: W030yModel
    ...
    override fun onSurfaceCreated(gl: GL10, config: EGLConfig?) {
        ...
        // シェーダプログラム登録
        programHandle = W030Shader().loadShader()
