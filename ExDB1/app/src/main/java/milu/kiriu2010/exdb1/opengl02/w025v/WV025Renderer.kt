package milu.kiriu2010.exdb1.opengl02.w025v
...
// ---------------------------------------------------
class WV025Renderer(ctx: Context): MgRenderer(ctx) {
    ...
    override fun onDrawFrame(gl: GL10) {
        ...
        // モデル描画(トーラス)
        shader.draw(modelTorus,boTorus,matMVP,matM,matI,vecLight,vecEye,vecAmbientColor)
        ...
        // モデル描画(球体)
        shader.draw(modelSphere,boSphere,matMVP,matM,matI,vecLight,vecEye,vecAmbientColor)
    }
