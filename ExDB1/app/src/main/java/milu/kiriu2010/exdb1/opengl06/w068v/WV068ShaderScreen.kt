...
// ------------------------------------
class WV068ShaderScreen: ES20MgShader() {
    // 頂点シェーダ
    private val scv =
            """
    ...
    override fun loadShader(): ES20MgShader {
        ...
        // uniform()
        hUNI[5] = GLES20.glGetUniformLocation(programHandle, "u_mask")
        MyGLES20Func.checkGlError("u_mask:glGetUniformLocation")
    ...
    fun draw(model: MgModelAbs,
        ...
        // uniform()
        GLES20.glUniform1i(hUNI[5], u_mask)
