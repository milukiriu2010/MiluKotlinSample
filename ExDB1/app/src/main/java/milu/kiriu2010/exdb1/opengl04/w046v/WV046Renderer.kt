...
// -------------------------------------------------------
class WV046Renderer(ctx: Context): MgRenderer(ctx) {
    // 描画オブジェクト(立方体)(背景)
    ...
    // シェーダ
    private lateinit var shader: WV046Shader
    ...
    override fun onDrawFrame(gl: GL10?) {
        ...
        shader.draw(modelCube,boCube,matM,matMVP,vecEye,0,0,refractRatio)
        ...
        Matrix.multiplyMM(matMVP,0,matVP,0,matM,0)
        shader.draw(modelSphere,boSphere,matM,matMVP,vecEye,-1,1,refractRatio)
        ...
        Matrix.multiplyMM(matMVP,0,matVP,0,matM,0)
        shader.draw(modelTorus,boTorus,matM,matMVP,vecEye,-1,1,refractRatio)
    }
