package milu.kiriu2010.exdb1.glsl02.g015v
...
// -------------------------------------------
class GLSLV15Renderer(ctx: Context): MgRenderer(ctx) {
    // 描画モデル
    ...
    // シェーダ
    private lateinit var shader: GLSLV15Shader
