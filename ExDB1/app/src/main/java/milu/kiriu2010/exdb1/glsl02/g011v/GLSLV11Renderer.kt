package milu.kiriu2010.exdb1.glsl02.g011v
...
// -------------------------------------------
// 視野角からレイを定義したレイマーチング:VBOあり
// OpenGL ES 2.0
// -------------------------------------------
// https://wgld.org/d/glsl/g011.html
// -------------------------------------------
class GLSLV11Renderer(ctx: Context): MgRenderer(ctx) {
    // 描画モデル
    ...
    // シェーダ
    private lateinit var shader: GLSLV11Shader
